...
public class MyHashMap03<K, V> {
	 ...
	 * @param capacity
	 */
	public MyHashMap03(int capacity) {
		super();
		if (capacity < 0) {
	...
	public V get(K key){
		...
		throw new RuntimeException("没有找到Key:"+key+"的键值对");
	}
	...
	public static void main(String[] args) {
		MyHashMap03<Integer, String> m1 = new MyHashMap03<>(4);
		MyHashMap03<Integer, String> m2 = new MyHashMap03<>(4);
