...
public class StoreStudent02 {
	...
	public void mapToList(Map m) {
		List<StudentEntry> l1 = new ArrayList<>();
		StudentEntry<Integer,Student> en = new StudentEntry(m);
		l1.add(en);
		Iterator<StudentEntry> iter = l1.iterator();
		while(iter.hasNext()){
	...
	public static void main(String[] args) {
		...
		StoreStudent02 store1 = new StoreStudent02();
...
class StudentEntry02<K,V> {

	Set<Entry<K, V>> sEntry;
	List<Entry<K, V>> l1;

	public  StudentEntry02(Map<K,V> m) {
		sEntry = m.entrySet();
